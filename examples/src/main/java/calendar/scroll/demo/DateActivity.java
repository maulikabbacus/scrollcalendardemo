...
public class DateActivity extends AppCompatActivity {
    ...
    //month starts from 0
    HashMap<Integer,ArrayList<Integer>> monthList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dates.add(31);
        monthList.put(2,dates);
        ArrayList<Integer> datesA=new ArrayList<>();
        datesA.add(2);
        datesA.add(4);
        datesA.add(5);
        datesA.add(6);
...
//        });
    ...
    private boolean isUnavailable(int year, int month, int day) {
        ...
        ArrayList<Integer> dateList=monthList.get(month);
        if(dateList!=null&&dateList.contains(day))
        {
            return true;
        }
        else
