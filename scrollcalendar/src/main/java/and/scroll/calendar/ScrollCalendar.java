...
import and.scroll.calendar.adapter.LegendItem;
import and.scroll.calendar.adapter.ResProvider;
import and.scroll.calendar.adapter.ScrollCalendarAdapter;
...
import and.scroll.calendar.values.Defaults;
import and.scroll.calendar.values.Keys;
import and.scroll.calendar.R;
...
public class ScrollCalendar extends LinearLayoutCompat implements ResProvider {
    ...
    private void init(@NonNull Context context) {
        ...
        for (int i = 0; i < legend.length; i++) {
            ...
            legend[i] = new LegendItem(i + 2);
            else
                {
                    legend[i] = new LegendItem(1);
                }
        }
    }
